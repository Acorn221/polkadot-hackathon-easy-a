...
- [x] If the initial identify request fails then no reactions can be made :(
- [ ] In prod the getMany request is not working always :(
- [ ] The get many requests that do get returned don't always display the correct dislike
